...
var MemStorage = class {
  ...
  constructor() {
    ...
    this.demoBookings = /* @__PURE__ */ new Map();
  }
  ...
  async createDemoBooking(insertBooking) {
    const id = randomUUID();
    const booking = {
      ...insertBooking,
      id,
...
var demoBookings = pgTable("demo_bookings", {
  id: varchar("id").primaryKey().default(sql`gen_random_uuid()`),
...
var insertDemoBookingSchema = createInsertSchema(demoBookings).omit({
  id: true,
  createdAt: true
});
...
async function registerRoutes(app2) {
  ...
  app2.post("/api/demo-bookings", async (req, res) => {
    try {
