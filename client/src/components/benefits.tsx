  ...
  const benefits = [
    {
      ...
      description: "Automate repetitive tasks and reclaim valuable time to focus on strategic growth initiatives."
    },
    {
    ...
    },
    {
      ...
      description: "Never miss a lead with 24/7 automated follow-up that nurtures prospects into customers."
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            Real results from businesses like yours that chose to automate intelligently with AI.
          </p>
        </div>
